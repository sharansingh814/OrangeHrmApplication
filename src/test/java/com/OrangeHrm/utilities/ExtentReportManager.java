...
public class ExtentReportManager implements ITestListener{
	...
	public void onStart(ITestContext testContext){		
		...
		htmlReporter.config().setDocumentTitle("Orange HRM Automation Report"); // Tile of report
		htmlReporter.config().setReportName("Orange HRM  Functional Testing"); // name of the report
